 ...
 */
class Categoria extends \Base\Entity\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Categoria' . "\0" . 'idcategoria', '' . "\0" . 'Base\\Entity\\Categoria' . "\0" . 'titulo');
        }
