 ...
 */
class Cidade extends \Base\Entity\Cidade implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Cidade' . "\0" . 'idcidade', '' . "\0" . 'Base\\Entity\\Cidade' . "\0" . 'nome', '' . "\0" . 'Base\\Entity\\Cidade' . "\0" . 'estado');
        }
