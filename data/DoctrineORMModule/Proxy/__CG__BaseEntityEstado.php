 ...
 */
class Estado extends \Base\Entity\Estado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Base\\Entity\\Estado' . "\0" . 'idestado', '' . "\0" . 'Base\\Entity\\Estado' . "\0" . 'nome');
        }
